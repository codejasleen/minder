...
<Service id="minder-v1-AcceptedRiskService">AcceptedRiskService</Service>



| Method Name | Request Type | Response Type | Description |
| ----------- | ------------ | ------------- | ------------|
| CreateAcceptedRisk | [CreateAcceptedRiskRequest](#minder-v1-CreateAcceptedRiskRequest) | [CreateAcceptedRiskResponse](#minder-v1-CreateAcceptedRiskResponse) |  |
| ListAcceptedRisks | [ListAcceptedRisksRequest](#minder-v1-ListAcceptedRisksRequest) | [ListAcceptedRisksResponse](#minder-v1-ListAcceptedRisksResponse) |  |
| DeleteAcceptedRisk | [DeleteAcceptedRiskRequest](#minder-v1-DeleteAcceptedRiskRequest) | [DeleteAcceptedRiskResponse](#minder-v1-DeleteAcceptedRiskResponse) |  |
...
| GetVersion | [GetVersionRequest](#minder-v1-GetVersionRequest) | [GetVersionResponse](#minder-v1-GetVersionResponse) |  |
...
<Message id="minder-v1-AcceptedRisk">AcceptedRisk</Message>
...
| entity_id | <TypeLink type="string">string</TypeLink> |  |  |
| rule_type_id | <TypeLink type="string">string</TypeLink> |  |  |
| expires_at | <TypeLink type="google-protobuf-Timestamp">google.protobuf.Timestamp</TypeLink> |  |  |
...
<Message id="minder-v1-CreateAcceptedRiskRequest">CreateAcceptedRiskRequest</Message>

AcceptedRisk service


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| accepted_risk | <TypeLink type="minder-v1-AcceptedRisk">AcceptedRisk</TypeLink> |  |  |



<Message id="minder-v1-CreateAcceptedRiskResponse">CreateAcceptedRiskResponse</Message>
...
<Message id="minder-v1-DeleteAcceptedRiskRequest">DeleteAcceptedRiskRequest</Message>
...
<Message id="minder-v1-DeleteAcceptedRiskResponse">DeleteAcceptedRiskResponse</Message>
...
<Message id="minder-v1-GetVersionRequest">GetVersionRequest</Message>





<Message id="minder-v1-GetVersionResponse">GetVersionResponse</Message>
...
| commit | <TypeLink type="string">string</TypeLink> |  |  |
...
<Message id="minder-v1-ListAcceptedRisksRequest">ListAcceptedRisksRequest</Message>
...
<Message id="minder-v1-ListAcceptedRisksResponse">ListAcceptedRisksResponse</Message>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| accepted_risks | <TypeLink type="minder-v1-AcceptedRisk">AcceptedRisk</TypeLink> | repeated |  |
...
| description | <TypeLink type="string">string</TypeLink> |  | description is a short plaintext summary of the provider class. |
...
| provider_traits | <TypeLink type="minder-v1-ProviderType">ProviderType</TypeLink> | repeated | provider_traits declares the provider trait(s) this rule type requires an implementation of (e.g. "github", "git", "oci"). This is AND semantics: a rule type requires an implementation of every listed trait, not just one of them. For example, a rule type requiring ["git", "github"] needs a provider that implements both traits (e.g. to read repo contents via git and call a forge-specific API via github). If empty, the rule type is not gated by provider traits. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| type | <TypeLink type="string">string</TypeLink> |  | type is the type of the alert. * 'security_advisory' can only be used with the 'repository' entity type. * 'pull_request_comment' can only be used with the 'pull_request' entity type. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| review_message | <TypeLink type="string">string</TypeLink> |  | review_message is the message to post in the PR review. |
| action | <TypeLink type="string">string</TypeLink> | optional | action is the action to use for the PR review (comment or request_changes). Default is comment. |
...
| labels | <TypeLink type="string">string</TypeLink> | repeated | Labels to apply when creating the issue. This is not validated here as it will be validated by the repository provider, i.e. GitHub upon creation of the issue |
| assignees | <TypeLink type="string">string</TypeLink> | repeated | Usernames to assign when creating the issue. This is not validated here as it will be validated by the repository provider, i.e. GitHub upon creation of the issue |
...
| RELATION_ACCEPTED_RISK_GET | 46 |  |
| RELATION_ACCEPTED_RISK_CREATE | 47 |  |
| RELATION_ACCEPTED_RISK_DELETE | 48 |  |
